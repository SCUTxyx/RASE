...
MANIFEST=runs/rase_vnext/frozen/k3_cohort_manifest_v1.json
PROTOCOL=configs/rase_vnext_protocol_v1.json
OUT=runs/rase_vnext/k3_collect_v1
mkdir -p "$OUT"
...
for label in Spatial Object Goal Long; do
  ...
  echo "K3 oracle ready: $label ($suite)"
...
echo "K3 collection batch complete"
